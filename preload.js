...
contextBridge.exposeInMainWorld('api', {
  ...
  tasks: {
    ...
    aiAnalysis: (text, instruction, options) => ipcRenderer.invoke('ai-analysis', text, instruction, options),
  ...
  google: {
    ...
    calendarEvents: (maxResults, timeMin) => ipcRenderer.invoke('google-calendar-events', maxResults, timeMin),
  ...
  github: {
    ...
    fileContent: (owner, repo, filePath, ref) => ipcRenderer.invoke('github-file-content', owner, repo, filePath, ref),
    createIssue: (owner, repo, title, body, labels) => ipcRenderer.invoke('github-create-issue', owner, repo, title, body, labels),
    recentCommits: (owner, repo, branch, perPage) => ipcRenderer.invoke('github-recent-commits', owner, repo, branch, perPage)
  },
